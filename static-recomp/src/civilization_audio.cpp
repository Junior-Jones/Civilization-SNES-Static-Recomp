...
extern "C" size_t civ_v20_audio_available_internal(const CivRecomp *i){return i&&g_owner==i?sc_static_apu_pcm_available():0u;}
extern "C" size_t civ_v20_audio_read_internal(CivRecomp *i,int16_t *out,uint8_t *known,size_t capacity){return i&&g_owner==i?sc_static_apu_pcm_read(out,known,capacity):0u;}
extern "C" uint64_t civ_v20_audio_overflow_internal(const CivRecomp *i){return i&&g_owner==i?sc_static_apu_pcm_overflow_count():0u;}
